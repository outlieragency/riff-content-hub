...
const ITEMS = [
  ...
  },
  {
    ...
    a: 'ช่วงนี้เปิดให้ creator ในไทยทดลองใช้ฟรีก่อน เก็บ feedback ไปเรื่อย ๆ ราคาจะประกาศหลังเปิดให้ใช้กว้างขึ้น คนที่อยู่ใน waitlist ก่อน จะได้ early lock ที่ราคาดีที่สุดเสมอ',
  },
  {
