...
const ITEMS = [
  {
    ...
    a: 'ใส่ URL channel ที่อยาก follow ระบบ scan ให้ ตัวที่ดังเกินค่าเฉลี่ย channel จะขึ้น feed กด save ตัวที่ชอบ AI จะอ่าน transcript แปลไทย สรุปประเด็น แล้วเขียนใหม่เป็น Facebook Post ในเสียงของคุณ พร้อมทำภาพปกตาม FB template ที่คุณ upload',
  },
  {
